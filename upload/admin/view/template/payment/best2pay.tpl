            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td><textarea cols="40" rows="5" name="best2pay_callback"><?php echo $callback; ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="best2pay_commission" value="<?php echo $best2pay_commission; ?>"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="best2pay_sort_order" value="<?php echo $best2pay_sort_order; ?>"
                                   size="1"/></td>
                    </tr>
                    <tr>
                        <td><span class="required">*</span> <?php echo $entry_kkt; ?></td>
                        <td><input type="text" name="best2pay_kkt" value="<?php echo $best2pay_kkt; ?>"/>
                            <?php if ($error_kkt) { ?>
                            <span class="error"><?php echo $error_kkt; ?></span>
                            <?php } ?></td>
                    </tr>
                    <tr>
                        <td><span class="required">*</span> <?php echo $entry_tax; ?></td>
                        <td><input type="text" name="best2pay_tax" value="<?php echo $best2pay_tax; ?>"/>
                            <?php if ($error_tax) { ?>
